...
function ComplaintTracking() {
  ...
  useEffect(() => {
    ...
    // Show complaints where user is either student or assigned staff
    const filtered = stored.filter(
      (c) =>
        c.student === loggedInUser.id ||
        c.assignedTo === loggedInUser.id
    );
  ...
  if (!loggedInUser)
    return <p>Please login to view complaints</p>;
